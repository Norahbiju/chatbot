...
class IngestionTests(unittest.TestCase):
    ...
    def test_valid_object_event_starts_job(self):
        self.client.list_ingestion_jobs.return_value = {"ingestionJobSummaries": []}
        self.client.start_ingestion_job.return_value = {"ingestionJob": {"ingestionJobId": "job-1"}}
    ...
    def test_multiple_events_start_one_job(self):
        self.client.list_ingestion_jobs.return_value = {"ingestionJobSummaries": []}
        self.client.start_ingestion_job.return_value = {"ingestionJob": {"ingestionJobId": "job-1"}}
    ...
    def test_bedrock_throttling_retries_batch(self):
    ...
    def test_malformed_sqs_message_fails_only_that_message(self):
